...
class SaveAsCatrobatImage with LoggableMixin {
  ...
  TaskEither<Failure, File> prepareTask(
      CatrobatImageMetaData data, CatrobatImage image) {
    ...
    try {
      ...
      logger.severe("Failed to serialize CatrobatImage object", err, stacktrace);
      return TaskEither.left(SaveImageFailure.unidentified);
    }
  }
}
