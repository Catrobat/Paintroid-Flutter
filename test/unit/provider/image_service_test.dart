...
void main() async {
  ...
  final testPngFile = await rootBundle.load('test/assets/images/test.png');
  final testJpgFile = await rootBundle.load('test/assets/images/test.jpg');
  ...
  test('Should return project preview', () {
    const path = 'test/assets/images/test.png';
