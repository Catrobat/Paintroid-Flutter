...
class _FakePaint_3 extends _i1.SmartFake implements _i2.Paint {
  _FakePaint_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class _FakePathWithActionHistory_4 extends _i1.SmartFake
    implements _i5.PathWithActionHistory {
...
class _FakePictureRecorder_5 extends _i1.SmartFake
    implements _i2.PictureRecorder {
  _FakePictureRecorder_5(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeCanvas_6 extends _i1.SmartFake implements _i2.Canvas {
  _FakeCanvas_6(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockICommandManager extends _i1.Mock implements _i6.ICommandManager {
  ...
  @override
  List<_i7.Command> get undoStack => (super.noSuchMethod(
        Invocation.getter(#undoStack),
        returnValue: <_i7.Command>[],
      ) as List<_i7.Command>);

  @override
  List<_i7.Command> get redoStack => (super.noSuchMethod(
        Invocation.getter(#redoStack),
        returnValue: <_i7.Command>[],
      ) as List<_i7.Command>);

  @override
  void setUndoStack(List<_i7.Command>? commands) => super.noSuchMethod(
        Invocation.method(
          #setUndoStack,
          [commands],
        ),
  ...
  @override
  void clearUndoStack({Iterable<_i7.Command>? newCommands}) =>
      super.noSuchMethod(
        Invocation.method(
          #clearUndoStack,
          [],
...
///
/// See the documentation for Mockito's code generation for more information.
class MockCommandFactory extends _i1.Mock implements _i11.CommandFactory {
  MockCommandFactory() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i3.PathCommand createPathCommand(
    _i5.PathWithActionHistory? path,
    _i2.Paint? paint,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGraphicFactory extends _i1.Mock implements _i12.GraphicFactory {
  MockGraphicFactory() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.PathWithActionHistory createPathWithActionHistory() =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  _i2.PictureRecorder createPictureRecorder() => (super.noSuchMethod(
        ...
        returnValue: _FakePictureRecorder_5(
          this,
          Invocation.method(
            #createPictureRecorder,
            [],
