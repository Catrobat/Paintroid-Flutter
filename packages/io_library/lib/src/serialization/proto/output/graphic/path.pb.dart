...
class SerializablePath_Action_MoveTo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SerializablePath.Action.MoveTo', createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SerializablePath_Action_MoveTo copyWith(void Function(SerializablePath_Action_MoveTo) updates) => super.copyWith((message) => updates(message as SerializablePath_Action_MoveTo)) as SerializablePath_Action_MoveTo;
...
class SerializablePath_Action_LineTo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SerializablePath.Action.LineTo', createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'x', $pb.PbFieldType.OD)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'y', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SerializablePath_Action_LineTo copyWith(void Function(SerializablePath_Action_LineTo) updates) => super.copyWith((message) => updates(message as SerializablePath_Action_LineTo)) as SerializablePath_Action_LineTo;
...
class SerializablePath_Action_Close extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SerializablePath.Action.Close', createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SerializablePath_Action_Close copyWith(void Function(SerializablePath_Action_Close) updates) => super.copyWith((message) => updates(message as SerializablePath_Action_Close)) as SerializablePath_Action_Close;
...
class SerializablePath_Action extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SerializablePath.Action', createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<SerializablePath_Action_MoveTo>(1, _omitFieldNames ? '' : 'moveTo', subBuilder: SerializablePath_Action_MoveTo.create)
    ..aOM<SerializablePath_Action_LineTo>(2, _omitFieldNames ? '' : 'lineTo', subBuilder: SerializablePath_Action_LineTo.create)
    ..aOM<SerializablePath_Action_Close>(3, _omitFieldNames ? '' : 'close', subBuilder: SerializablePath_Action_Close.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SerializablePath_Action copyWith(void Function(SerializablePath_Action) updates) => super.copyWith((message) => updates(message as SerializablePath_Action)) as SerializablePath_Action;
...
class SerializablePath extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SerializablePath', createEmptyInstance: create)
    ..pc<SerializablePath_Action>(1, _omitFieldNames ? '' : 'actions', $pb.PbFieldType.PM, subBuilder: SerializablePath_Action.create)
    ..e<SerializablePath_FillType>(2, _omitFieldNames ? '' : 'fillType', $pb.PbFieldType.OE, defaultOrMaker: SerializablePath_FillType.NON_ZERO, valueOf: SerializablePath_FillType.valueOf, enumValues: SerializablePath_FillType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SerializablePath copyWith(void Function(SerializablePath) updates) => super.copyWith((message) => updates(message as SerializablePath)) as SerializablePath;
