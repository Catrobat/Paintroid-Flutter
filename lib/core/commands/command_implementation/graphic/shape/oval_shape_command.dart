...
part 'oval_shape_command.g.dart';

@JsonSerializable()
class OvalShapeCommand extends ShapeCommand {
  double width;
  double height;
  @OffsetConverter()
  Offset center;
  ...
  OvalShapeCommand(
    ...
    this.angle, {
    int? version,
    this.type = SerializerType.OVAL_SHAPE_COMMAND,
  }) : version = version ??
            VersionStrategyManager.strategy.getOvalShapeCommandVersion();
  ...
  @override
  Map<String, dynamic> toJson() => _$OvalShapeCommandToJson(
      this);

  factory OvalShapeCommand.fromJson(Map<String, dynamic> json) {
    int version = json['version'] as int;
    json['angle'] = json['angle'] ?? 0.0;

    switch (version) {
      case Version.v1:
        return _$OvalShapeCommandFromJson(json);
      case Version.v2:
