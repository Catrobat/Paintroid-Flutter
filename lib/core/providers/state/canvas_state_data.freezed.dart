...
mixin _$CanvasStateData {
  ...
  ui.Offset get cursorPosition => throw _privateConstructorUsedError;
...
class _$CanvasStateDataImpl implements _CanvasStateData {
  ...
  @override
  final ui.Offset cursorPosition;

  @override
  String toString() {
    return 'CanvasStateData(backgroundImage: $backgroundImage, cachedImage: $cachedImage, size: $size, commandManager: $commandManager, graphicFactory: $graphicFactory, cursorPosition: $cursorPosition)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, backgroundImage, cachedImage,
      size, commandManager, graphicFactory, cursorPosition);
...
abstract class _CanvasStateData implements CanvasStateData {
  const factory _CanvasStateData(
      ...
      required final ui.Offset cursorPosition}) = _$CanvasStateDataImpl;
